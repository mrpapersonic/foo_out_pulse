...
typedef int(__stdcall *pa_proplist_sets)(pa_proplist *p, const char *key,
																				const char *value);
typedef int(__stdcall *pa_proplist_setp)(pa_proplist *p, const char *pair);
typedef int(__stdcall *pa_proplist_set)(pa_proplist *p, const char *key,
...
typedef void(__stdcall *pa_threaded_mainloop_signal)(pa_threaded_mainloop *m,
																									 int wait_for_accept);
...
struct pa_mainloop_api {
	...
	pa_defer_event *(*defer_new)(pa_mainloop_api *a, pa_defer_event_cb_t cb,
															 void *userdata);
...
typedef int (*pa_poll_func)(struct pollfd *ufds, unsigned long nfds,
...
struct pa_mainloop {
	...
	unsigned io_events_please_scan, time_events_please_scan,
...
typedef int(__stdcall *pa_stream_connect_playback)(pa_stream *s, const char *dev,
...
typedef int(__stdcall *pa_stream_write)(pa_stream *p, const void *data,
																			size_t nbytes, pa_free_cb_t free_cb,
...
typedef const pa_buffer_attr *(__stdcall *pa_stream_get_buffer_attr)(
		pa_stream *s);
typedef pa_operation *(__stdcall *pa_stream_drain)(pa_stream *s,
																								 pa_stream_success_cb_t cb,
																								 void *userdata);
typedef void(__stdcall *pa_stream_set_state_callback)(pa_stream *s,
																										pa_stream_notify_cb_t cb,
																										void *userdata);
typedef void(__stdcall *pa_stream_set_write_callback)(pa_stream *p,
																										pa_stream_request_cb_t cb,
																										void *userdata);
typedef void(__stdcall *pa_stream_set_underflow_callback)(
		pa_stream *p, pa_stream_notify_cb_t cb, void *userdata);
typedef void(__stdcall *pa_stream_set_started_callback)(pa_stream *p,
																											pa_stream_notify_cb_t cb,
																											void *userdata);
typedef pa_operation *(__stdcall *pa_stream_cork)(pa_stream *s, int b,
																								pa_stream_success_cb_t cb,
																								void *userdata);
typedef int(__stdcall *pa_stream_is_corked)(pa_stream *s);
typedef pa_operation *(__stdcall *pa_stream_flush)(pa_stream *s,
																								 pa_stream_success_cb_t cb,
																								 void *userdata);
typedef int(__stdcall *pa_stream_get_latency)(pa_stream *s, pa_usec_t *r_usec,
																						int *negative);
typedef pa_operation *(__stdcall *pa_stream_update_timing_info)(
		pa_stream *p, pa_stream_success_cb_t cb, void *userdata);
typedef const pa_timing_info *(__stdcall *pa_stream_get_timing_info)(
		pa_stream *s);
typedef const pa_sample_spec *(__stdcall *pa_stream_get_sample_spec)(
		pa_stream *s);
typedef pa_operation *(__stdcall *pa_stream_trigger)(pa_stream *p,
																									 pa_stream_success_cb_t cb,
																									 void *userdata);
typedef pa_operation *(__stdcall *pa_stream_update_sample_rate)(
		pa_stream *s, uint32_t rate, pa_stream_success_cb_t cb, void *userdata);
typedef pa_usec_t(__stdcall *pa_bytes_to_usec)(uint64_t length,
																						 const pa_sample_spec *spec);
typedef size_t(__stdcall *pa_usec_to_bytes)(pa_usec_t t,
																					const pa_sample_spec *spec);
...
typedef pa_channel_map *(__stdcall *pa_channel_map_init_auto)(
...
typedef pa_operation *(__stdcall *pa_context_set_sink_input_volume)(
...
typedef pa_cvolume *(__stdcall *pa_cvolume_set)(pa_cvolume *a, unsigned channels,
																							pa_volume_t v);
typedef void(__stdcall *pa_context_set_event_callback)(pa_context *p,
																										 pa_context_event_cb_t cb,
																										 void *userdata);

typedef int(__stdcall *pa_cvolume_valid)(const pa_cvolume *v);
typedef int(__stdcall *pa_cvolume_equal)(const pa_cvolume *a,
																			 const pa_cvolume *b);
...
typedef pa_operation *(__stdcall *pa_context_get_sink_input_info)(
		pa_context *c, uint32_t idx, pa_sink_input_info_cb_t cb, void *userdata);
...
typedef pa_operation *(__stdcall *pa_context_subscribe)(
		pa_context *c, pa_subscription_mask_t m, pa_context_success_cb_t cb,
		void *userdata);
typedef void(__stdcall *pa_context_set_subscribe_callback)(
