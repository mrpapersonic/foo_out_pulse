/* dear god this is fugly */
#pragma once
#include <stdint.h>
#define PA_CHANNELS_MAX 32U
typedef bool pa_bool_t; // hopefully is the same size?
...
typedef const char *(__stdcall *pa_strerror)(int error);
typedef pa_operation *(__stdcall *pa_operation_ref)(pa_operation *o);
typedef void(__stdcall *pa_operation_unref)(pa_operation *o);
typedef void(__stdcall *pa_operation_cancel)(pa_operation *o);
...
typedef pa_proplist *(__stdcall *pa_proplist_new)(void);
typedef void(__stdcall *pa_proplist_free)(pa_proplist *p);
typedef int(__stdcall *pa_proplist_sets)(pa_proplist *p, const char *key, const char *value);
typedef int(__stdcall *pa_proplist_setp)(pa_proplist *p, const char *pair);
typedef int(__stdcall *pa_proplist_set)(pa_proplist *p, const char *key, const void *data, size_t nbytes);
...
typedef void(__stdcall *pa_threaded_mainloop_stop)(pa_threaded_mainloop *m);
typedef void(__stdcall *pa_threaded_mainloop_lock)(pa_threaded_mainloop *m);
typedef void(__stdcall *pa_threaded_mainloop_unlock)(pa_threaded_mainloop *m);
typedef void(__stdcall *pa_threaded_mainloop_wait)(pa_threaded_mainloop *m);
...
typedef void(__stdcall *pa_io_event_cb_t)(pa_mainloop_api *ea, pa_io_event *e, int fd, pa_io_event_flags_t events,
                                          void *userdata);
typedef void(__stdcall *pa_io_event_destroy_cb_t)(pa_mainloop_api *a, pa_io_event *e, void *userdata);
typedef void(__stdcall *pa_time_event_cb_t)(pa_mainloop_api *a, pa_time_event *e, const struct timeval *tv,
                                            void *userdata);
typedef void(__stdcall *pa_time_event_destroy_cb_t)(pa_mainloop_api *a, pa_time_event *e, void *userdata);
typedef void(__stdcall *pa_defer_event_cb_t)(pa_mainloop_api *a, pa_defer_event *e, void *userdata);
typedef void(__stdcall *pa_defer_event_destroy_cb_t)(pa_mainloop_api *a, pa_defer_event *e, void *userdata);
struct pa_io_event {
...
typedef pa_context *(__cdecl *pa_context_new_with_proplist)(pa_mainloop_api *mainloop, const char *name,
                                                            pa_proplist *proplist);
typedef void(__stdcall *pa_context_unref)(pa_context *c);
typedef pa_context *(__stdcall *pa_context_ref)(pa_context *c);
typedef void(__stdcall *pa_context_set_state_callback)(pa_context *c, pa_context_notify_cb_t cb, void *userdata);
typedef void(__stdcall *pa_context_set_event_callback)(pa_context *p, pa_context_event_cb_t cb, void *userdata);
typedef int(__stdcall *pa_context_errno)(pa_context *c);
typedef int(__stdcall *pa_context_is_pending)(pa_context *c);
typedef pa_context_state_t(__stdcall *pa_context_get_state)(pa_context *c);
typedef int(__stdcall *pa_context_connect)(pa_context *c, const char *server, pa_context_flags_t flags,
...
typedef pa_stream *(__stdcall *pa_stream_new)(pa_context *c, const char *name, const pa_sample_spec *ss,
...
typedef int(__stdcall *pa_stream_connect_playback)(pa_stream *s, const char *dev, const pa_buffer_attr *attr,
                                                   pa_stream_flags_t flags, const pa_cvolume *volume,
                                                   pa_stream *sync_stream);
typedef int(__stdcall *pa_stream_disconnect)(pa_stream *s);
typedef int(__stdcall *pa_stream_cancel_write)(pa_stream *p);
typedef int(__stdcall *pa_stream_write)(pa_stream *p, const void *data, size_t nbytes, pa_free_cb_t free_cb,
                                        int64_t offset, pa_seek_mode_t seek);
typedef int(__stdcall *pa_stream_drop)(pa_stream *p);
typedef size_t(__stdcall *pa_stream_writable_size)(pa_stream *p);
typedef const pa_buffer_attr *(__stdcall *pa_stream_get_buffer_attr)(pa_stream *s);
typedef pa_operation *(__stdcall *pa_stream_drain)(pa_stream *s, pa_stream_success_cb_t cb, void *userdata);
typedef void(__stdcall *pa_stream_set_state_callback)(pa_stream *s, pa_stream_notify_cb_t cb, void *userdata);
typedef void(__stdcall *pa_stream_set_write_callback)(pa_stream *p, pa_stream_request_cb_t cb, void *userdata);
typedef void(__stdcall *pa_stream_set_underflow_callback)(pa_stream *p, pa_stream_notify_cb_t cb, void *userdata);
typedef void(__stdcall *pa_stream_set_started_callback)(pa_stream *p, pa_stream_notify_cb_t cb, void *userdata);
typedef pa_operation *(__stdcall *pa_stream_cork)(pa_stream *s, int b, pa_stream_success_cb_t cb, void *userdata);
typedef int(__stdcall *pa_stream_is_corked)(pa_stream *s);
typedef pa_operation *(__stdcall *pa_stream_flush)(pa_stream *s, pa_stream_success_cb_t cb, void *userdata);
typedef int(__stdcall *pa_stream_get_latency)(pa_stream *s, pa_usec_t *r_usec, int *negative);
typedef pa_operation *(__stdcall *pa_stream_update_timing_info)(pa_stream *p, pa_stream_success_cb_t cb,
                                                                void *userdata);
typedef const pa_timing_info *(__stdcall *pa_stream_get_timing_info)(pa_stream *s);
typedef const pa_sample_spec *(__stdcall *pa_stream_get_sample_spec)(pa_stream *s);
typedef pa_operation *(__stdcall *pa_stream_trigger)(pa_stream *p, pa_stream_success_cb_t cb, void *userdata);
typedef pa_operation *(__stdcall *pa_stream_update_sample_rate)(pa_stream *s, uint32_t rate, pa_stream_success_cb_t cb,
                                                                void *userdata);
typedef pa_usec_t(__stdcall *pa_bytes_to_usec)(uint64_t length, const pa_sample_spec *spec);
typedef size_t(__stdcall *pa_usec_to_bytes)(pa_usec_t t, const pa_sample_spec *spec);
...
typedef pa_channel_map *(__stdcall *pa_channel_map_init_auto)(pa_channel_map *m, unsigned channels,
                                                              pa_channel_map_def_t def);
typedef pa_operation_state_t(__stdcall *pa_operation_get_state)(pa_operation *o);

typedef uint32_t(__stdcall *pa_stream_get_index)(pa_stream *s);
typedef pa_volume_t(__stdcall *pa_sw_volume_from_dB)(double f);
typedef double(__stdcall *pa_sw_volume_to_dB)(pa_volume_t v);
typedef pa_operation *(__stdcall *pa_context_set_sink_input_volume)(pa_context *c, uint32_t idx,
                                                                    const pa_cvolume *volume,
                                                                    pa_context_success_cb_t cb, void *userdata);
typedef pa_cvolume *(__stdcall *pa_cvolume_init)(pa_cvolume *a);
typedef pa_cvolume *(__stdcall *pa_cvolume_set)(pa_cvolume *a, unsigned channels, pa_volume_t v);
typedef void(__stdcall *pa_context_set_event_callback)(pa_context *p, pa_context_event_cb_t cb, void *userdata);

typedef int(__stdcall *pa_cvolume_valid)(const pa_cvolume *v);
typedef int(__stdcall *pa_cvolume_equal)(const pa_cvolume *a, const pa_cvolume *b);
...
typedef void(__stdcall *pa_sink_input_info_cb_t)(pa_context *c, const pa_sink_input_info *i, int eol, void *userdata);
typedef pa_operation *(__stdcall *pa_context_get_sink_input_info)(pa_context *c, uint32_t idx,
...
typedef void(__stdcall *pa_context_subscribe_cb_t)(pa_context *c, pa_subscription_event_type_t t, uint32_t idx,
                                                   void *userdata);
typedef pa_operation *(__stdcall *pa_context_subscribe)(pa_context *c, pa_subscription_mask_t m,
                                                        pa_context_success_cb_t cb, void *userdata);
typedef void(__stdcall *pa_context_set_subscribe_callback)(pa_context *c, pa_context_subscribe_cb_t cb, void *userdata);
